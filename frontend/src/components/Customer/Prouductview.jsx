...
import { FaStar, FaShoppingCart, FaMinus, FaPlus, FaShare, FaTag, FaInfoCircle, FaShieldAlt, FaBox, FaCheckCircle } from 'react-icons/fa';
...
const Productview = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Topbar />
            <div className="max-w-screen-2xl mx-auto px-6 py-8 mt-10">
                                                ...
                                                {inCart ? (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-xs sm:text-sm font-medium whitespace-nowrap">
                                                            Cart ({cartItemDetail?.quantity || 1})
                                                        </span>
                                                    </button>
                                                ) : (
                                                    <button
