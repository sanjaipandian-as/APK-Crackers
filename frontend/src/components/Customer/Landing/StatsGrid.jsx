            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm h-full flex flex-col">
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-auto">
                        <img src="https://images.unsplash.com/photo-1700623066384-555c048e50e2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8ZGl3YWxpJTIwY3JhY2tlcnN8ZW58MHx8MHx8fDA%3D" className="rounded-lg h-20 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                        <img src="https://images.unsplash.com/photo-1572098688575-0db28b6a165b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGRpd2FsaSUyMGNyYWNrZXJzfGVufDB8fDB8fHww" className="rounded-lg h-20 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                        <img src="https://media.istockphoto.com/id/645713294/photo/fireworks.jpg?s=612x612&w=0&k=20&c=Fh-AGfLgSjIwzlDipGogSbdsKrKU5PxOCCh0plXE-N0=" className="rounded-lg h-20 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm h-full flex flex-col hover:shadow-lg transition-shadow cursor-pointer">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4 flex-grow">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4kCjRBzhwKsmcfxSe_y-7CyJhUIXz-j7nig&s" alt="" className="rounded-lg h-40 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4kCjRBzhwKsmcfxSe_y-7CyJhUIXz-j7nig&s" className="rounded-lg h-40 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj1vkyLax_Tr063fVse4zuoykOG-w86WVMnw&s" className="rounded-lg h-40 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfYkrOzFi6JPsdACNsJeGhB2oMTjZjJJmarBL_wEEqAw&s" className="rounded-lg h-40 w-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onError={(e) => { e.target.src = '/images/placeholder.jpg'; e.target.onerror = null; }} />
                    </div>
